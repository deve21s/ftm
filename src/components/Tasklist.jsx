...
function Tasklist({task, taskdetail,deletetask}) {
    return (
        <div className="bg-gray-400 rounded-md space-x-1 space-y-1 mb-2 w-full p-2 grid grid-cols-2 grid-rows-2 grid-flow-row" onClick={() => taskdetail(task)}>
